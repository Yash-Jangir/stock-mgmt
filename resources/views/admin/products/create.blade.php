<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <a href="{{ route('admin.products.index') }}">{{ __('Product') }}</a> > {{ __('Create') }}
        </h2>
    </x-slot>
    ...
    <section class="py-8 gap-2">
        <form method="post" action="{{ route('admin.products.store') }}" id="update-form" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="grid grid-cols-2 gap-4 col-span-2">
                            <div>
                                ...
                                <x-text-input id="code" name="code" type="text" class="mt-1 block w-full" :value="old('code')" placeholder="{{ __('Product Code') }}" required />
                                <x-input-error class="mt-2" :messages="$errors->get('code')" />
                            </div>

                            <div>
                                <x-input-label for="name" :value="__('Product Name')" />
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name')" placeholder="{{ __('Product Name') }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="price" name="price" type="number" class="mt-1 block w-full" :value="old('price')" placeholder="{{ __('Price') }}" required />
                            ...
                            <div>
                                ...
                                <select name="age_group" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                    ...
                                    @foreach ($ageGroups as $ageGroup)
                                        <option value="{{ $ageGroup->value }}">{{ $ageGroup->label() }}</option>
                                    @endforeach
                                </select>
