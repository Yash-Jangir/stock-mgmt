...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code'        => ['required', Rule::unique('products')->ignore($this->route('product'), 'id')->where('user_id', auth()->id()), 'string', 'max:255'],
            ...
            'sku_id.*'          => ['numeric', Rule::exists('skus', 'id')->where('user_id', auth()->id())],
